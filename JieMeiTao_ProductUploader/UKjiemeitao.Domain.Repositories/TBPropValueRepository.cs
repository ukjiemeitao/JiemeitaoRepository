...
{
    public class TBPropValueRepository : EntityFrameworkRepository<TB_PropValue>, ITBPropValueRepository
    {
        public TBPropValueRepository(IRepositoryContext context)
            : base(context)
        { }
